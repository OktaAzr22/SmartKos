...
@section('content')
    ...
    <div class="mt-6 bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-700 shadow-sm dark:shadow-zinc-900/50 overflow-hidden">
        ...
        <div class="max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-zinc-700 scrollbar-track-gray-100 dark:scrollbar-track-zinc-800">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                ...
                <thead class="bg-gray-50 dark:bg-zinc-800 sticky top-0 z-10">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-zinc-400 uppercase w-16">
                            No
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-zinc-400 uppercase">
                            Nama Kategori
                        </th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-zinc-400 uppercase w-32">
                            Aksi
                        </th>
                    </tr>
                </thead>
                    ...
                    @foreach ($kategori as $i => $item)
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center space-x-3">
                                    ...
                                    <button
                                        ...
                                        class="text-indigo-600 dark:text-indigo-400 hover:opacity-80 transition">
                                        <i class="fas fa-edit"></i>
                                    </button>

                                    {{-- DELETE --}}
                                    <button type="button"
                                        class="delete-btn text-red-600 dark:text-red-400 hover:opacity-80 transition"
                        ...
                        <x-animated-modal
                            ...
                            <form action="{{ route('keuangan.kategori.update', $item->id_kategori) }}"
                                ...
                                <div class="mb-4">
                                    <label
                                        class="block text-gray-700 dark:text-zinc-300 text-sm font-medium mb-2">
                                        Nama Kategori
                                    </label>
                                ...
                                <div class="flex justify-end space-x-3 mt-6">
                                    ...
                                    <button type="button"
                                        ...
                                        class="px-4 py-2 font-medium
                                               text-gray-600 dark:text-zinc-400 
                                               hover:text-gray-900 dark:hover:text-zinc-200 transition">
                                        Batal
                                    </button>
    ...
    @else
        ...
        <div class="py-16 flex flex-col items-center justify-center">
            ...
            <div class="w-16 h-16 bg-gray-100 dark:bg-zinc-800
                        rounded-full flex items-center justify-center mb-4">
                <i class="fas fa-folder-open text-gray-400 dark:text-zinc-500 text-xl"></i>
            </div>
