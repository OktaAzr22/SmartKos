...
<div class="mt-6 bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-700 shadow-sm overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-zinc-700 flex justify-between items-center">
        ...
        <a href="{{ route('pengeluaran.index') }}" 
           class="text-gray-400 dark:text-zinc-400 hover:text-gray-600 dark:hover:text-zinc-200 transition">
    ...
    <div class="p-6">
        <form id="formPengeluaran" action="{{ route('pengeluaran.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select name="id_kategori" id="id_kategori"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 
                            ...
                            <option value="" class="dark:bg-zinc-800">-- Pilih Kategori --</option>

                            @foreach($kategori as $item)
                                <option value="{{ $item->id_kategori }}" class="dark:bg-zinc-800"
                    ...
                    <div>
                        <label for="jumlah" class="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-2">
                            Jumlah Pengeluaran
                        </label>
                    ...
                    <div>
                        <label for="tanggal" class="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-2">
                            Tanggal Pengeluaran
                        </label>
            ...
            <div class="flex justify-end space-x-3 mt-8 pt-6 border-t border-gray-200 dark:border-zinc-700">
