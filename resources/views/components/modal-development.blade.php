<div id="modal-development" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md p-4 transform scale-95 transition-transform duration-300 ease-out">
        <div class="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-lg dark:shadow-zinc-900/50">
            <div class="flex items-center justify-between p-4 border-b dark:border-zinc-700">
                ...
                <button type="button" onclick="closeDevModal()" 
                    class="text-gray-400 hover:text-gray-600 dark:text-zinc-400 dark:hover:text-zinc-200">
                    <i class="fas fa-times"></i>
                </button>
            </div>

            <div class="p-6 text-center">
                <i class="fas fa-tools text-5xl text-yellow-500 dark:text-yellow-400 mb-3 animate-bounce"></i>
            ...
            <div class="flex justify-center p-4 border-t dark:border-zinc-700">
                <button type="button" onclick="closeDevModal()"
                    class="px-5 py-2 text-sm font-medium text-white bg-gray-600 dark:bg-zinc-600 
                           rounded-lg hover:bg-gray-700 dark:hover:bg-zinc-500 
                           focus:ring-4 focus:ring-gray-300 dark:focus:ring-zinc-700">
                    Mengerti
                </button>
            </div>
        </div>
